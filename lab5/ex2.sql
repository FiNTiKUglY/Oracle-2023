...
BEGIN
    IF INSERTING THEN
        INSERT INTO LOGS(ACTION, TIME, PERSON_ID, NEW_PERSON_NAME, NEW_PERSON_BIRTHDAY, NEW_PERSON_AMOUNT)
            VALUES ('INSERT', SYSTIMESTAMP, :NEW.ID, :NEW.NAME, :NEW.BIRTHDAY_DATE, :NEW.BOOKS_AMOUNT);
    ELSIF UPDATING THEN
        INSERT INTO LOGS(ACTION, TIME, PERSON_ID, NEW_PERSON_NAME, NEW_PERSON_BIRTHDAY, NEW_PERSON_AMOUNT, OLD_PERSON_NAME, OLD_PERSON_BIRTHDAY, OLD_PERSON_AMOUNT)
    ...
    ELSIF DELETING THEN
        INSERT INTO LOGS(ACTION, TIME, PERSON_ID, OLD_PERSON_NAME, OLD_PERSON_BIRTHDAY, OLD_PERSON_AMOUNT)
...
BEGIN
    IF INSERTING THEN
        INSERT INTO LOGS(ACTION, TIME, PUBLISHER_ID, NEW_PUBLISHER_NAME, NEW_PUBLISHER_OPENING, NEW_PUBLISHER_AMOUNT)
            VALUES ('INSERT', SYSTIMESTAMP, :NEW.ID, :NEW.NAME, :NEW.OPENING_DATE, :NEW.BOOKS_AMOUNT);
    ELSIF UPDATING THEN
        INSERT INTO LOGS(ACTION, TIME, PUBLISHER_ID, NEW_PUBLISHER_NAME, NEW_PUBLISHER_OPENING, NEW_PUBLISHER_AMOUNT, OLD_PUBLISHER_NAME, OLD_PUBLISHER_OPENING, OLD_PUBLISHER_AMOUNT)
            VALUES ('UPDATE', SYSTIMESTAMP, :NEW.ID, :NEW.NAME, :NEW.OPENING_DATE, :NEW.BOOKS_AMOUNT, :OLD.NAME, :OLD.OPENING_DATE, :OLD.BOOKS_AMOUNT);
    ELSIF DELETING THEN
        INSERT INTO LOGS(ACTION, TIME, PUBLISHER_ID, OLD_PUBLISHER_NAME, OLD_PUBLISHER_OPENING, OLD_PUBLISHER_AMOUNT)
...
BEGIN
    IF INSERTING THEN
        INSERT INTO LOGS(ACTION, TIME, BOOK_ID, NEW_BOOK_TITLE, NEW_BOOK_RELEASE, NEW_BOOK_PERSON_ID, NEW_BOOK_PUBLISHER_ID)
            VALUES ('INSERT', SYSTIMESTAMP, :NEW.ID, :NEW.TITLE, :NEW.RELEASE_DATE, :NEW.PERSON_ID, :NEW.PUBLISHER_ID);
    ELSIF UPDATING THEN
        INSERT INTO LOGS(ACTION, TIME, BOOK_ID, NEW_BOOK_TITLE, NEW_BOOK_RELEASE, NEW_BOOK_PERSON_ID, NEW_BOOK_PUBLISHER_ID, OLD_BOOK_TITLE, OLD_BOOK_RELEASE, OLD_BOOK_PERSON_ID, OLD_BOOK_PUBLISHER_ID)
    ...
    ELSIF DELETING THEN
        INSERT INTO LOGS(ACTION, TIME, BOOK_ID, OLD_BOOK_TITLE, OLD_BOOK_RELEASE, OLD_BOOK_PERSON_ID, OLD_BOOK_PUBLISHER_ID)
